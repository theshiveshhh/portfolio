...
var typed = new Typed(".typing-text", {
  strings: ["Full-Stack development", "Tech Communities", "UI/UX Design"],
  loop: true,
  typeSpeed: 50,
  backSpeed: 25,
  backDelay: 500,
...
$("#contact-form").submit(function (event) {
  ...
  event.preventDefault();
  emailjs.init("PxewEjaElGvImhPKd");
  console.log("form submitted");
  emailjs.sendForm("service_v17flnj", "template_5141sih", "#contact-form").then(
    function (response) {
